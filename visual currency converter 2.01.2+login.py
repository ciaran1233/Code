...
option.place(x=160,y=314,width=300,height=40)



button =Button(converter,text="convert",fg="grey",font=("arial",25),bg="powderblue",command=ok)
button.place(x=250,y=355,height=36,width=110)
